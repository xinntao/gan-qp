...
imgs = glob.glob('/mnt/SSD/xtwang/CelebA_attr/train_256/all_256/*.png')
...
g_train_model = multi_gpu_model(g_train_model, gpus=2)
...
d_train_model = multi_gpu_model(d_train_model, gpus=2)
...
if __name__ == '__main__':
    ...
    logs = {'fid': [], 'best': 1000}
    # logs = json.load(open('logs.txt', 'w+'))
